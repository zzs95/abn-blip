...
@registry.register_processor("abnclip_caption")
class ABNClipCaptionProcessor(BaseProcessor):
...
@registry.register_processor("abnclip_feat_train")
class ABNClipFeatTrainProcessor(BaseProcessor):
    def __init__(
        self, 
    ):
        super().__init__()
...
@registry.register_processor("abnclip_feat_eval")
class ABNClipFeatEvalProcessor(BaseProcessor):
    def __init__(
        self,
    ):
        super().__init__()
