...
class MedCLIPVisionModelI3DResNet(nn.Module):
    '''
    take I3DResNet as backbone.
    '''
    def __init__(self, checkpoint=None, medclip_checkpoint=None):
        from image_encoder import ImageClassifier
        super().__init__()
        self.model = ImageClassifier(out_channels=constants.CLASS_NUM)
...
class MedCLIPModel(nn.Module):
    def __init__(self,
        vision_cls=MedCLIPVisionModelI3DResNet,
        checkpoint=None,
        ...
        assert vision_cls in [MedCLIPVisionModelI3DResNet], 'vision_cls should be one of [MedCLIPVisionModelI3DResNet]'
